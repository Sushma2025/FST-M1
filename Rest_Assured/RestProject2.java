...
public class RestProject2 {
	String sshKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJSI1rIX69SGS/E6x/ETaiXc6Rx437xbIgTK5PHUOLsxazuread";
    int sshKeyId;
    // Request specification
    RequestSpecification requestSpec = new RequestSpecBuilder().
            setBaseUri("https://api.github.com/user/keys").
            addHeader("Authorization", "token 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").
